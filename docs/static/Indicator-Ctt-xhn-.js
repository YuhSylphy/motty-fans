import{r as $,j as o}from"./jsx-runtime-_5WuVDLK.js";import{a as N}from"./hooks-DVGqdmTD.js";import{i as B,k as F,o as D,j as d,g as l,b as i,p as I,u as U,_ as E,c as K,h as W}from"./DefaultPropsProvider-CSjmKMGg.js";import{B as A}from"./Backdrop-Diuy1ohG.js";function G(r){return B("MuiCircularProgress",r)}F("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","circle","circleDeterminate","circleIndeterminate","circleDisableShrink"]);const H=["className","color","disableShrink","size","style","thickness","value","variant"];let u=r=>r,P,S,b,j;const t=44,L=D(P||(P=u`
  0% {
...
`)),V=r=>{const{classes:e,variant:s,color:a,disableShrink:m}=r,p={root:["root",s,`color${l(a)}`],svg:["svg"],circle:["circle",`circle${l(s)}`,m&&"circleDisableShrink"]};return W(p,G,e)},Z=d("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(r,e)=>{const{ownerState:s}=r;return[e.root,e[s.variant],e[`color${l(s.color)}`]]}})(({ownerState:r,theme:e})=>i({display:"inline-block"},r.variant==="determinate"&&{transition:e.transitions.create("transform")},r.color!=="inherit"&&{color:(e.vars||e).palette[r.color].main}),({ownerState:r})=>r.variant==="indeterminate"&&I(b||(b=u`
