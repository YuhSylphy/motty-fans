...
import { AppBar, Box, Button, IconButton, Link, Toolbar, Typography, useTheme } from '@material-ui/core';
...
const Footer: React.FC = () => {
  ...
  return (
    <Box display="flex" justifyContent="flex-end" margin={theme.spacing(0.2)}>
      <Link href="https://www.youtube.com/user/MOTTYGAMES/" target="__blank">MOTTV</Link>
    </Box>
  );
}
